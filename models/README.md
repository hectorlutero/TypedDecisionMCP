...
- `DECIDE_ENGINE=head-mlp` — segundo motor (embedding + probe). Default continua `logits` até o gate. Pesos em `$DECIDE_HEAD_MLP` ou `~/.cache/TypedDecisionMCP/head-mlp.json`
