...
The motor is local head-mlp (MiniLM) by default; logits via DECIDE_ENGINE=logits. It does not generate answer tokens. Trust `action` and the typed `answers`. Never invent a probability in the chat text.
